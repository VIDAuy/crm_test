...
$titulo_pagina = $produccion ? "Operaciones - Producción" : "Operaciones - Testing";
$titulo_menu = $produccion ? "<span class='text-danger'>Panel de operaciones - PROD<span>" : "<span class='text-success'>Panel de operaciones - TEST<span>";
